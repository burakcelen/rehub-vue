<template>
  <div class="h-100 w-100">
    ...
    <p> Our experienced Professional Indemnity team provide a fast and proactive approach to all classes of Professional Indemnity/Errors & Omissions business produced by, and in conjunction with, our broad ranging producers from across the world.
    </p>
...
<style scoped>
#indemnity {
  background-image: url('/src/assets/img/hand.jpg');
